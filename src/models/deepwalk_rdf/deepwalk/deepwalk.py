...
def process(args):
  ...
  if args.format == "adjlist":
    ...
    G = graph.load_edgelist_from_memory(args.edgelist, undirected=False)
  else:
...
def run(**kwargs):
  ...
  # args.max_memory_data_size = 1000000000
  ...
  # special argument for translation model.
  args.edgelist = kwargs.pop("edgelist")
  args.format = kwargs.pop("format")
  args.representation_size = kwargs.pop("dim")
  args.output = kwargs.pop('output')+"/random_walk_vector"
  # args.log = args.output

  # log setting
  numeric_level = 0 #getattr(logging, args.log.upper(), None)
